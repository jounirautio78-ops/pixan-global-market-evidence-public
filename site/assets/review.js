...
function renderReviewMetrics(data) {
  ...
  const metrics = [
    [reviewL("Avoin maapohja", "Open country base"), reviewGlobalBaseData ? `${reviewGlobalBaseData.countries.length} / 195` : "— / 195", reviewGlobalBaseData ? reviewL(`${reviewGlobalBaseData.summary.observedCount} World Bank -havaintoa; ei sähkötupakkamyyntiä`, `${reviewGlobalBaseData.summary.observedCount} World Bank records; no vaping sales`) : reviewL("Pohjakerros ei ole saatavilla; atlaksen maaluetteloa ei käytetä sen korvikkeena", "Base layer unavailable; the atlas country list is not substituted for it")],
