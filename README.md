...
Dashboard release `2026.07.31-38` adds Switzerland's official CHF 4.43/ml price anchor, the current tariff/control-key route and a visible commercial-reuse rights gate. The price is an official report input for nicotine refill liquids and disposable contents; it is not a complete annual market average, taxed volume, annual sales value or retail-market figure and is not multiplied into a market total. FOCBS did not supply the requested annual taxed millilitres, category excise or nationwide retail sales. Public TN8 records remain border-stage evidence, and derived SwissImpex trade totals are withheld because the applicable `terms_by_ask` condition requires prior permission for commercial use. See [`source/SWITZERLAND_FOCBS_RESPONSE_AND_PRICE_ANCHOR_2026-07-31.md`](source/SWITZERLAND_FOCBS_RESPONSE_AND_PRICE_ANCHOR_2026-07-31.md).

The live market dataset now contains 85 observations from 25 sources. The count of official observations remains 75: 39 market measures and 36 Sweden FHM registration-structure records. Switzerland adds only a `published_price_input`, not an official market measure or a country-year retail total. The six downloadable lender-package files remain the reviewed `2026.07.31-37` daily snapshot and were not rebuilt; they are generated at most once per Asia/Nicosia calendar day and retain their own visible version. Canada's CAD 1,219,160,000 / EUR 822,583,715.21 point estimate, New Zealand's 7/10 donor result and Poland's broad device-tax scope remain unchanged. Euromonitor remains paused; no extract, purchase, fee, order, licence or commitment is authorised. Each Evidence Register still exposes 60 reviewed v37 claims. The separate open official-data base covers 195 countries with 578 observed World Bank values; 390 WHO or UN Comtrade route records remain queued and missing. The method-control layer classifies the same 195 countries as 28 reviewed country plans, 0 reviewed source leads, 15 regional EU TPD patterns and 152 country-unscoped proxy routes. None of those method classes or demographic, economic, prevalence-route or trade-route records is eligible as retail sales, so the donor gate remains 0/3 and the global market value remains `null/not_computed`.
