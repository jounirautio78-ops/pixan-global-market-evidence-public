...
Release `2026.07.27-28` keeps the bilingual Evidence Registers at 53 reviewed claims and the market dataset at 84 observations from 24 sources. Of the 75 official observations, 39 are market measures and 36 are Sweden FHM registration-structure records. The separate open official-data base covers 195 countries with 578 observed World Bank values; 390 WHO or UN Comtrade route records remain queued and missing. None of those demographic, economic, prevalence-route or trade-route records is eligible as retail sales, so the global market value remains `null`. Poland retains its official 2020–2023 e-liquid litres and separate 2025 device and component-set excise bridge, neither of which is consumer retail value or donor evidence. The v28 integrity hotfix separates actual vendor-document receipt history from G1–G6 outcomes, makes the open-base headline fail closed if that asset is unavailable, and corrects the global-base schema identifier. Euromonitor remains 0/6 passed with 6/6 evaluated, NOT SCORED and not authorised for purchase. The donor gate remains 0/3.
