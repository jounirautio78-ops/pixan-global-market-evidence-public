...
Release `2026.07.25-24` keeps the bilingual Evidence Registers at 53 reviewed claims. The market evidence contains 79 observations from 21 sources. Its 70 official observations are explicitly separated into 34 market measures across seven countries and 36 Swedish FHM register-structure counts for 2018–2026. The FHM counts describe reporting entities and notified, active and withdrawn products; they are not sales, sales volume or market value, the 2026 records are a snapshot rather than a completed annual period, and the donor gate remains 0/3. The release retains the privacy-safe Euromonitor checkpoint and adds a source-audited Canada closure pack: the official 2024 retail point estimate is CAD 1,219,160,000 (EUR 822.58 million), Canada passes 7/10 donor criteria, and D5, D7 and D10 remain open.
