...
Dashboard and daily-package release `2026.07.31-37` closes the no-charge Statistics Canada clarification without changing Canada's CAD 1,219,160,000 / EUR 822,583,715.21 point estimate. The authority confirmed the same tax basis for the quarterly, monthly and archived tables, identified the RCS target population as NAICS 441100–459993 and stated that exact product-class CV, imputation, standard-error and annual-covariance fields are unavailable. Canada remains NOT ACCEPTED at 7/10: D5 and D7 fail, D8 passes and D10 remains open. An independent route map now ranks an already processed Health Canada ATI report, provincial retail-tax bases, the statutory VPRR duty field and customs and channel controls; no request was sent. New Zealand's reproducible 2024 customs controls and a 7 August follow-up pack were prepared but not sent; New Zealand remains NOT ACCEPTED at 7/10 with D5 failed and D8/D10 open. Poland's 4,382,500 implied taxed devices and 62,500 component sets are corrected to a broad statutory group that includes e-cigarettes, heated-tobacco heaters and multifunction devices; Poland has no country-year retail value and receives no donor score or cockpit candidate. Euromonitor remains paused; no extract, purchase, fee, order, licence or commitment is authorised. The six downloadable lender-package files share the reviewed `2026.07.31-37` daily snapshot with the dashboard and are generated at most once per Asia/Nicosia calendar day. The market dataset remains at 84 observations from 24 sources and each Evidence Register exposes 60 reviewed claims. Of the 75 official observations, 39 are market measures and 36 are Sweden FHM registration-structure records. The separate open official-data base still covers 195 countries with 578 observed World Bank values; 390 WHO or UN Comtrade route records remain queued and missing. The method-control layer classifies the same 195 countries as 28 reviewed country plans, 0 reviewed source leads, 15 regional EU TPD patterns and 152 country-unscoped proxy routes. None of those method classes or demographic, economic, prevalence-route or trade-route records is eligible as retail sales, so the donor gate remains 0/3 and the global market value remains `null/not_computed`.
