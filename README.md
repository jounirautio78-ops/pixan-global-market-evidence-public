...
Dashboard release `2026.07.31-39` adds a bounded donor-closure evidence sprint for Canada, Germany, New Zealand and Poland. Canada gains two CTNS 2022 consumer-source point estimates while precision is withheld because the public PUMF and bootstrap ID sets do not match. Germany gains product-specific CPI weights and six year-specific official WZ 47.26 supplies-and-services turnover envelopes, all explicitly non-vape-only. New Zealand gains store, website and legal-entity denominator controls without turning incompatible units into a coverage rate. Poland gains official unit, excise, customs and revision-conflict observations plus a clearly secondary historical institutional benchmark. See [`source/DONOR_CLOSURE_SPRINT_CA_DE_NZ_PL_2026-07-31.md`](source/DONOR_CLOSURE_SPRINT_CA_DE_NZ_PL_2026-07-31.md).

The live market dataset now contains 112 observations from 40 sources. The 94 official observations comprise 58 market measures and 36 Sweden FHM registration-structure records. The six downloadable lender-package files remain the reviewed `2026.07.31-37` daily snapshot and were not rebuilt; they are generated at most once per Asia/Nicosia calendar day and retain their own visible version. Canada's CAD 1,219,160,000 / EUR 822,583,715.21 point estimate and 7/10 decision remain unchanged; the ~63% CTNS user-source shares support only potential channel materiality, not sales or monetary materiality. New Zealand remains 7/10, and Poland still has no scored full-market retail candidate. Euromonitor remains paused; no extract, purchase, fee, order, licence or commitment is authorised. Each Evidence Register still exposes 60 reviewed v37 claims. The separate open official-data base covers 195 countries with 578 observed World Bank values; 390 WHO or UN Comtrade route records remain queued and missing. The method-control layer classifies the same 195 countries as 28 reviewed country plans, 0 reviewed source leads, 15 regional EU TPD patterns and 152 country-unscoped proxy routes. None of those method classes or demographic, economic, prevalence-route or trade-route records is eligible as retail sales, so the donor gate remains 0/3 and the global market value remains `null/not_computed`.
