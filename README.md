...
Dashboard release `2026.08.02-41` publishes the next fail-closed donor-control checkpoint. New Zealand's tighter official 2024 HS10 selection produces imports of NZD 189.641 million at value for duty and NZD 203.341 million at CIF, exports of NZD 6.270 million FOB and net border proxies of NZD 183.371 million and NZD 197.070 million. These are different-stage diagnostics only; the candidate-to-proxy ratios are not margin, uplift, validation intervals or a market range. Canada's NAICS 459999 specialist-channel exclusion, missing exact NAPCS 5619122 quality metrics and unresolved retail-to-shipment bridge remain explicit. Germany benchmark `DE-BLIND-1.0.0` is prospectively locked to the final 2023 and 2024 official taxed-liquid anchors, with 15% annual and 10% combined caps, before any future vendor submission is scored. It remains **NOT SCORED** and has no automatic donor or commercial effect. See [`source/NZ_CA_DE_DONOR_CONTROL_SPRINT_2026-08-02.md`](source/NZ_CA_DE_DONOR_CONTROL_SPRINT_2026-08-02.md).

The live market dataset contains 156 observations from 47 sources. The 134 official observations comprise 98 market measures and 36 Sweden FHM registration-structure records. The six downloadable English/Finnish lender-package files are the reviewed `2026.08.02-41` daily snapshot; they are generated at most once per Asia/Nicosia calendar day. Canada remains NOT ACCEPTED at 7/10, New Zealand remains NOT ACCEPTED at 7/10 and Germany's prospective vendor benchmark does not change its donor decision. Euromonitor remains paused; no extract, purchase, fee, order, licence or commitment is authorised. Each Evidence Register exposes 60 reviewed v41 claims. The separate open official-data base covers 195 countries with 578 observed World Bank values; 390 WHO or UN Comtrade route records remain queued and missing. The method-control layer classifies the same 195 countries as 28 reviewed country plans, 0 reviewed source leads, 15 regional EU TPD patterns and 152 country-unscoped proxy routes. None of those method classes or demographic, economic, prevalence-route or trade-route records is eligible as retail sales, so the donor gate remains 0/3 and the global market value remains `null/not_computed`.
