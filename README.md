...
Release `2026.07.27-27` keeps the bilingual Evidence Registers at 53 reviewed claims and expands the market dataset to 84 observations from 24 sources. Of the 75 official observations, 39 are market measures and 36 are Sweden FHM registration-structure records. The separate open official-data base covers 195 countries with 578 observed World Bank values; 390 WHO or UN Comtrade route records remain queued and missing. None of those demographic, economic, prevalence-route or trade-route records is eligible as retail sales, so the global market value remains `null`. Poland now has official e-liquid litres for 2020–2023 and a deterministic 2025 device and component-set excise bridge, but neither is consumer retail value or donor evidence. The expanded Euromonitor review includes a 78-market list and a private Germany numerical subtest, but the current-field, exact-matrix, official tax/stage/scope bridge and transaction-rights gaps remain; the automated gate reports 0/6 passed with 6/6 evaluated. The quote indicator remains separate, the route is NOT SCORED and no purchase is authorised. The donor gate remains 0/3.
