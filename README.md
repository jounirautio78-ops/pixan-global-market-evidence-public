...
Dashboard release `2026.07.31-40` extends the bounded donor-closure sprint for Canada, Germany, New Zealand and Poland. Canada gains a Health Canada-published 2021 market and channel benchmark, Germany a reproducible 2024 Eurostat supply bridge, New Zealand official 2019 and 2023 HES expenditure estimates, and Poland a 2019-2022 producer/importer quantity series plus a disposable-only commercial segment estimate. Every new value remains outside the global roll-up. See [`source/DONOR_CLOSURE_SPRINT_CA_DE_NZ_PL_2026-07-31.md`](source/DONOR_CLOSURE_SPRINT_CA_DE_NZ_PL_2026-07-31.md).

The live market dataset now contains 156 observations from 47 sources. The 134 official observations comprise 98 market measures and 36 Sweden FHM registration-structure records. The six downloadable lender-package files remain the reviewed `2026.07.31-37` daily snapshot and were not rebuilt; they are generated at most once per Asia/Nicosia calendar day and retain their own visible version. Canada keeps its CAD 1,219,160,000 / EUR 822,583,715.21 2024 RCS point estimate and 7/10 decision; a Health Canada-published CAD 2.04 billion 2021 benchmark now makes the historical boundary gap visible but cannot be transferred to 2024. New Zealand remains 7/10 despite new 2019 and 2023 HES controls. Germany adds a reproducible EUR 608.335 million apparent-supply control and a deliberately non-retail EUR 1.040 billion zero-margin tax/VAT sensitivity. Poland adds a 2019-2022 producer/importer quantity series and a disposable-only 2023 commercial segment estimate but still has no scored full-market retail candidate. Euromonitor remains paused; no extract, purchase, fee, order, licence or commitment is authorised. Each Evidence Register still exposes 60 reviewed v37 claims. The separate open official-data base covers 195 countries with 578 observed World Bank values; 390 WHO or UN Comtrade route records remain queued and missing. The method-control layer classifies the same 195 countries as 28 reviewed country plans, 0 reviewed source leads, 15 regional EU TPD patterns and 152 country-unscoped proxy routes. None of those method classes or demographic, economic, prevalence-route or trade-route records is eligible as retail sales, so the donor gate remains 0/3 and the global market value remains `null/not_computed`.
