...
Dashboard and daily-package release `2026.07.30-36` corrects the tax basis of Statistics Canada quarterly table 20-10-0071-01 without changing any market value or donor decision. The authority's table-specific clarification confirms that GST/HST/PST/QST are excluded, additional duties embedded in retail prices are included and four quarters form the intended annual value. Canada remains NOT ACCEPTED at 7/10 with D5, D7 and D10 open. A no-charge follow-up seeks the exact vaping-duty components, monthly and legacy-table tax bases, NAICS coverage and annual uncertainty fields. Germany's narrowed reply was sent before the 11 August 2026 deadline and expressly withholds consent to paid processing. Euromonitor remains paused; no extract, purchase, fee, order, licence or commitment is authorised. The six downloadable lender-package files share the reviewed `2026.07.30-36` daily snapshot with the dashboard and are generated at most once per Asia/Nicosia calendar day. The market dataset remains at 84 observations from 24 sources and each Evidence Register exposes 60 reviewed claims. Of the 75 official observations, 39 are market measures and 36 are Sweden FHM registration-structure records. The separate open official-data base still covers 195 countries with 578 observed World Bank values; 390 WHO or UN Comtrade route records remain queued and missing. The method-control layer classifies the same 195 countries as 28 reviewed country plans, 0 reviewed source leads, 15 regional EU TPD patterns and 152 country-unscoped proxy routes. None of those method classes or demographic, economic, prevalence-route or trade-route records is eligible as retail sales, so the donor gate remains 0/3 and the global market value remains `null/not_computed`.
