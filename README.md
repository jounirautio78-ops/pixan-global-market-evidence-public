...
Release `2026.07.27-26` keeps the bilingual Evidence Registers at 53 reviewed claims and the market dataset at 79 observations from 23 sources. New official-source audits leave New Zealand D8/D10 and Canada D5/D7/D10 open, so both candidates remain NOT ACCEPTED at 7/10. A separate, source-linked 15-country acquisition screen names Poland as the practical primary third-country programme, Finland, Denmark and France as the secondary wave, and Russia only as a high-friction source lead. The screen creates no market observation or donor score. Three vendor follow-ups due 28 July are published as prepared drafts but remain NOT SENT; NIQ stays outside the wave until its terms and permitted-use gate is reviewed. The donor gate remains 0/3 and no global value is published.
